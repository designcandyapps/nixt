  ...
  methods:{
    ...
    async generatePalette(){
      ...
      while(colors.length<4){
        ...
        //https://unsplash.com/photos/a-woman-wearing-a-plaid-scarf-and-earrings-3djyHTykdww?w=800&amp;auto=format&amp;fit=crop&amp;q=60&amp;ixlib=rb-4.0.3&amp;ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHw0NHx8fGVufDB8fHx8fA%3D%3D`;
