...
<template>
  <div id="ff">
    <ULandingHero v-if="page.hero" v-bind="page.hero">
      <div class="zg"><img id="xx" src="https://pinfluents.com/_BCK/4/im/lo.png"><canvas id="ca" ref="canvas" width="60" height="60"></canvas>
      <input id="q" v-model="q"><div id="response" v-if="response">{{response}}</div><ImageGenerator /></div>
...
this,function(){
  if(!t)var t={map:function(t,r){
  var n={};
  return r?t.map(function(t,o){
    return n.index=o,r.call(n,t)}):t.slice()},naturalOrder:function(t,r){
return t<r?-1:t>r?1:0},
sum:function(t,r){
  var n={};
  return t.reduce(r?function(t,o,e){return n.index=e,t+r.call(n,o)}:function(t,r){return t+r},0)},max:function(r,n){return Math.max.apply(null,n?t.map(r,n):r)}};
  var r=function(){
    var r=5,n=8-r,o=1e3;function e(t,n,o){return(t<<2*r)+(n<<r)+o}
    function i(t){var r=[],n=!1;
    function o(){r.sort(t),n=!0
  }
  return{push:function(t){r.push(t),n=!1},peek:function(t){return n||o(),void 0===t&&(t=r.length-1),r[t]},
  pop:function(){return n||o(),r.pop()},
  size:function(){return r.length}, //
  map:function(t){return r.map(t)},
  debug:function(){return n||o(),r}}}
  ...
  if(n.count()){
    ...
    if(u==o)for(a=n.r1;a<=n.r2;a++){
      ...
      for(h=n.b1;h<=n.b2;h++)
      c+=r[e(a,s,h)]||0;v[a]=f+=c
    }
    else if(u==i)for(a=n.g1;a<=n.g2;a++){
    for(c=0,s=n.r1;s<=n.r2;s++)
    for(h=n.b1;h<=n.b2;h++)c+=r[e(s,a,h)]||0;v[a]=f+=c
  }
  else for(a=n.b1;a<=n.b2;a++){
    for(c=0,s=n.r1;s<=n.r2;s++)
    for(h=n.g1;h<=n.g2;h++)c+=r[e(s,h,a)]||0;v[a]=f+=c}
    return v.forEach(function(t,r){l[r]=f-t}),
  function(t){
    var r,o,e,i,u,s=t+"1",h=t+"2",c=0;for(a=n[s];a<=n[h];a++)
    if(v[a]>f/2){
      for(e=n.copy(),
      i=n.copy(),
      u=(r=a-n[s])<=(o=n[h]-a)?Math.min(n[h]-1,
      ~~(a+o/2)):Math.max(n[s],
      ~~(a-1-r/2));
      !v[u];)u++;
      for(c=l[u];!c&&v[u-1];)c=l[--u];
      return e[h]=u,i[s]=e[h]+1,[e,i]}}(u==o?"r":u==i?"g":"b")}}
      return u.prototype={volume:function(t){
      return this._volume&&!t||(this._volume=(this.r2-this.r1+1)*(this.g2-this.g1+1)*(this.b2-this.b1+1)),this._volume},
      count:function(t){
        var r=this.histo;if(!this._count_set||t){
        var n,o,i,u=0;for(n=this.r1;n<=this.r2;n++)
...
push:function(t){
  ...
  palette:function(){
    return this.vboxes.map(function(t){return t.color})
  },
    size:function(){
...
var f=function(t){
  ...
  return t.forEach(function(t){
    o=e(t[0]>>n,t[1]>>n,t[2]>>n),i[o]=(i[o]||0)+1}),i}(h);
    f.forEach(function(){});
    var v=function(t,r){
	...
	new u(a,s,h,c,f,v,r)}(h,f),
	l=new i(function(r,n){return t.naturalOrder(r.count(),n.count())});
	function g(t,r){
      for(var n,e=t.size(),i=0;i<o;){if(e>=r)return;if(i++>o)return;if((n=t.pop()).count()){
      var u=s(f,n),a=u[0],h=u[1];if(!a)return;t.push(a),h&&(t.push(h),e++)
}
else t.push(n),i++}}l.push(v),g(l,.75*c);for(var p=new i(function(r,n){
      return t.naturalOrder(r.count()*r.volume(),n.count()*n.volume())});l.size();)
p.push(l.pop());
g(p,c);
for(var d=new a;
p.size();)d.push(p.pop());
...
return this.context.getImageData(0,0,this.width,this.height);
  alert("D: "+this.context.getImageData(0,0,this.width,this.height)); //+++++


};
var o=function(){};
return o.prototype.getColor=function(t,r){
  alert("T3: "+t); alert("R: "+r); //+++++


  return void 0===r&&(r=10),this.getPalette(t,5,r)[0]},o.prototype.getPalette=function(t,o,e){


  //var f=document.createElement("img");
  //f.setAttribute("id","ww");
  ...
  //e=e.decode(); //::toDataURL;
  e.onload=function(){
    //this.toDataURL();
    //////alert("E: "+this);
    //alert("E: "+this.toDataURL());
  }

  //f.src="https://pinfluents.com/im/dc2.png";//decode

/*
  var r=new FileReader();
  r.onload=function(){
    f=document.getElementById("ww");
    alert("F: "+f); //+++++-
    f.src=this.result;
    alert("F: "+f.src); //+++++-
  };
  f="https://pinfluents.com/im/dc2.png";
  f=f.decode();
  r.readAsDataURL(f);
*/

  //e=document.getElementsByTagname("ee")[0];
  //alert("T: "+t); //++++^ZO
  //alert("O: "+o); //+++++-
  ...
  //alert("X: "+JSON.stringify(e,null,2)); //+++++^^^
...
var i=function(t){
  ...
  //++alert("U: "+JSON.stringify(u,null,2)); //++++^ZO
...
}},n.send()},o.prototype.getColorAsync=function(t,r,n){
var o=this;
alert("O: "+o); //+++++
