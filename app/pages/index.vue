...
<template>
  <div id="ff">
    <ULandingHero v-if="page.hero" v-bind="page.hero">
      <div class="g"><img id="xx" src="https://pinfluents.com/_BCK/4/im/lo.png"><canvas id="ca" ref="canvas" width="60" height="60"></canvas>
...
export default{
  ...
  mounted(){
    //const cv=document.getElementById("ca"); const cx=ca.getContext("2d"); //cx.fillStyle="red"; cx.fillRect(10,10,100,100); //alert("CA0: "+ca); 
    //this.getCP();
