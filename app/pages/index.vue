...
<template>
  <div>
    <ULandingHero v-if="page.hero" v-bind="page.hero">
      ...
      <nuxt-img id="nim" src="https://pinfluents.com/_BCK/4/im/dc2.png" width="60" height="60" @load="getCP" :custom="true" v-slot="{src,isLoaded,imgAttrs}">
        <img v-if="isLoaded" v-bind="imgAttrs" :src="src" />
        <img v-else src="https://pinfluents.com/_BCK/4/im/lo.png" alt="placeholder" />
      </nuxt-img>
